...
У висновку можна сказати що обидва алгоритми показали достатньо точний результат у пошуку значень. На графіку генетичного алгоритму можна побачити тенденцію до поступового покращення результату. На графіку випадкового пошуку результат знаходиться з різкими змінами помітними на графіку, через невелику кількість початкових комбінацій даних, всого два параметри з 20 варіантами для кожного, що не так багато. 
Також можна побачити що фітнес функція не досягає самого мінімуму, через велику інертність температури та неможливості ставити симуляцію на 20000+ кроків через обмеження системи. 
