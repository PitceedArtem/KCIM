...
- **CO2** кількість груп агентів молекул CO<sub>2</sub> в атмосфері (в групі 25 молекул).
...
Графік наочно показує лінійну залежність температури від яскравості випромінювання з граничними значеннями в 12, базовою температую землі за відсутності буд'якого випромінювання взагалі, та температури приблизно в 38 градусів при максимальному значенні випромінювання. 
