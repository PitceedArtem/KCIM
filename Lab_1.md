...
- **CO<sub>2</sub>** кількість агентів молекул CO<sub>2</sub> в атмосфері.
...
<br>
Графік наочно показує еспоненційну залежність температури Землі від кількості молекул CO<sub>2</sub>. Поки кількість молекул не значна, вона лише сповільнює швидкість випромінення с поверхні, відбиваючи частину тепла назад. Однак при значному рості кількості молекул CO<sub>2</sub>, кількість відбитих частинок тепла різко збільшується, та при значеннях більше 800 теоретично почне дуже повільно нескінченно зростати через те, що земля поглинає більше ніж випромінює та балансу кількості тепла не можливо досягнути. 
